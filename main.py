...
if __name__ == "__main__":
    ...
    if "--serve" in sys.argv:
        print("Iniciando MCP na porta padrão (6274)...")
        mcp.run()
    else:
        print("\n===== AI Sticky Notes - Teste Direto =====")
        while True:
            print("\nOpções:")
            print("1. Adicionar uma nota")
            print("2. Ver todas as notas")
            print("3. Ver a nota mais recente")
            print("4. Gerar prompt de resumo")
            print("0. Sair")
            ...
            if opcao == "1":
                ...
                print("\n--- NOTA MAIS RECENTE ---")
                print(get_latest_note())
                
            elif opcao == "4":
                print("\n--- PROMPT DE RESUMO ---")
                print(note_summary_prompt())
